...
Before working on WarriorHub, I used to think “design patterns” were just fancy terms from computer science textbooks. But as I built out the project, I realized how naturally these patterns appear in real systems—even in places we interact with every day. Design patterns aren’t strict rules; they’re more like familiar structures that help software stay organized and predictable. Seeing them show up in my own code made the project feel less like writing isolated components and more like arranging a coordinated system.
